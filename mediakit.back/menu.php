		...
		<div id="colMenu">
			<ul>
				<li>
					...
					<ul>
						<li <?php echo $active[1] ?>><a href="index.php">Banner Grande</a></li>
						<li <?php echo $active[2] ?>><a href="pb_pequeno.php">Banner peque&ntilde;o rectangular</a></li>
						<li <?php echo $active[3] ?>><a href="pb_estandar.php">Banner Est&aacute;ndar</a></li>
                        <li <?php echo $active[3] ?>><a href="pb_estandarg.php">Banner Est&aacute;ndar Grande</a></li>
                        <li <?php echo $active[3] ?>><a href="pb_cintillo.php">Banner Cintillo</a></li>
				...
				<li>
					...
					<ul>
						...
						<li <?php echo $active[12] ?>><a href="rm_cornerinferior.php">Banner Corner Inferior</a></li>
				...
				<li>
					<h3>Patrocinios</h3>
					<ul>
						<li <?php echo $active[16] ?>><a href="pa_seccion.php">Secci&oacute;n / Skin</a></li>
				...
				<li>
					...
					<ul>
						...
						<li <?php echo $active[21] ?>><a href="er_exclusivo.php">E-Rumba Exclusivo</a></li>
					</ul>
				</li>
				<li <?php echo $active[23] ?>><a href="otras_rumbas.php"><h3>Otras Rumbas</h3></a></li>
