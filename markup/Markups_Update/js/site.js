...
jQuery(document).ready(function(){
  ...
  jQuery("a[rel=external]").each(function(){jQuery(this).attr('target', '_blank');});
	...
	jQuery('ul.photo-teaser-cycle.fotos').cycle({
		fx: 'scrollHorz',
		speed: 1000,
		timeout: 0,
		sync: 1,
		...
		easing: 'easeInOutBack',
		containerResize: 1,
    pager:  'ul.carousel-images.fotos li ul.carousel-slide',
    pagerAnchorBuilder: function(idx, slide) {
     //-- return selector string for existing anchor
     return 'ul.carousel-images.fotos li ul.carousel-slide li:eq(' + idx + ') a'; 
    },
		delay: -2000
	});
...
//		delay: -2
//	});
	jQuery('ul.carousel-images').cycle({
		fx: 'scrollHorz',
		activePagerClass: 'active', //-- class name used for the active pager link
		speed: 1000,
		timeout: 0,
	...
	jQuery('ul.carousel-images.fotos').cycle({
		fx: 'scrollHorz',
		activePagerClass: 'active', //-- class name used for the active pager link
		speed: 1000,
		timeout: 0,
