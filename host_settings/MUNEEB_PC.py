...
FIXTURE_DIRS = (
   '/eclipse-workspace/rumba/locations/fixtures/',
 )

TEMPLATE_DIRS = ( 
    '/eclipse-workspace/rumba/templates',
 )

OLDBOGOTA_PHOTO_PATH = '/eclipse-workspace/oldbogota/processed'
...
APPLICATION_ROOT = '/eclipse-workspace/rumba/'
MEDIA_ROOT = '/eclipse-workspace/rumba/media'
STATIC_DOC_ROOT = '/eclipse-workspace/rumba/media'
...
LOCALE_PATHS = ( 
    '/eclipse-workspace/rumba/locale/',
 )
...
COMPRESS_ROOT        = "/eclipse-workspace/rumba/static/"
...
COMPRESS_YUI_BINARY  = 'java -jar /eclipse-workspace/rumba/yuicompressor-2.4.6.jar'
